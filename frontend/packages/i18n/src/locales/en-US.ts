...
const translations = {
  ...
  agents: {
    ...
    'clientSecret.agentIdLabel': 'Agent ID',
    'clientSecret.credentialsTitle': 'Credentials',
    ...
    'clientSecret.endpoints.authorize': 'Authorization endpoint',
    'clientSecret.endpoints.token': 'Token endpoint',
